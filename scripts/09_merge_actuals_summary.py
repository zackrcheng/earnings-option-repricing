...
# --- Load ---
summary = pd.read_csv('ibes2025/ibes_filtered/ibes_summary_sp500_filtered.csv')
actuals = pd.read_csv('ibes2025/ibes_filtered/ibes_actuals_sp500_filtered.csv')
...
schedule     = nyse.schedule(start_date='2014-01-01', end_date='2026-02-27')
...
# --- Step 7: Save ---
merged.to_csv('ibes2025/ibes_stage1_events.csv', index=False)
print("\nSaved: ibes2025/ibes_stage1_events.csv")